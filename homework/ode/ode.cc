...
//     double alpha = 1; //Heun's method
//     vector k0 = F(x, y);
//     vector k1 = F(x + alpha * h, y + alpha*k0*h);

//     vector dy_1 = h * k0;
//     vector dy_2 = h * ((1 - 0.5/alpha) * k0 + 0.5/alpha * k1);
//     return std::tuple(y + dy_2, dy_1 - dy_2);
// }
...
std::tuple<vector, vector> rkstep23( //Bogacki-Shampine embedded method
    ...
    // vector dy_3 = h * k3;
    return std::tuple(y + dy_3, dy_2 - dy_3);
}
